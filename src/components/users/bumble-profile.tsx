...
export default function BumbleProfile({
  user,
  children,
}: {
  user: User;
        ...
        <div className="container lg:w-2/6 xl:w-2/7 sm:w-full md:w-2/3 bg-white shadow-lg transform duration-200 ease-in-out">
          ...
          <div>
            <div className="text-center px-14">
              ...
              <a className="text-gray-400 mt-2 hover:text-blue-500" href="https://www.instagram.com/immohitdhiman/" target="_blank">{user?.email}</a>
              <p className="mt-2 text-gray-500 text-sm">{user?.username} es parte de la comunidad de Coffe Cod, donde la innovación y la colaboración nos unen.</p>
            </div>
            <hr className="mt-6" />
